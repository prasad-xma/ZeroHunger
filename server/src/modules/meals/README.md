...
```
meals/
├── meal.model.js          # Mongoose schema and validations
├── meal.controller.js     # Business logic for API endpoints
├── meal.routes.js         # Express routes configuration
├── meal.validators.js     # Custom validation functions
└── README.md             # This documentation
```

## 🗄️ Model (meal.model.js)
...
- **ingredients** (Array of Objects, required): List of ingredients (each object has name: string 1-100 chars, quantity: string 1-50 chars, calories: number 0-10000)
...
- **nutrition** (Object, required):
  ...
  - carbs (Number, 0-1000)
  - fat (Number, 0-500)
- **servingSizeGrams** (Number, required): Serving size in grams (1-5000)
...
```json
{
  ...
  "ingredients": [
    ...
    { "name": "Tomatoes", "quantity": "150g", "calories": 20 }
  ],
